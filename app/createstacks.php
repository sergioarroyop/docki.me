                    ...
                    <div id="ContentContainers" class="container-fluid mt-3 mb-3">
                        <div class="card card-top d-flex">
                            <div class="card-header">
                                <i class="fas fa-edit"></i> Create stack
                            </div>
                                ...
                                <div class="col-12">
                                   <div class="form-row">
                                       <div class="form-group col-12">
                                           <label for="namestack">Name</label>
                                           <input name="namestack" type="text" class="form-control" id="inameStack" placeholder="Stack name">
                                       </div>
                                   </div>
                                   <hr>
                                   <!--<div class="form-row">
                                       <div class="form-group col-12">
                                           ...
                                           <input type="file" class="form-control-file" id="stackFile">
									                 ...
									                 <div class="form-row">
										                  <div class="form-group col-12">
											                 <label for="stacktext">Stack file</label>
											                 <textarea name="stacktext" type="text" id="stack-creation-editor"></textarea>
										                  </div>
									                 </div>
                                   <hr>
                                   <div class="form-row">
                                       <div class="form-group col-12 d-flex justify-content-end mt-2">
                                           <button name="stacks" value="create" type="submit" class="btn btn-success">Create</button> 
                                       </div>
									                     <div class="col-12">
											                     <?php
